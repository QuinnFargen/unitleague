CREATE OR REPLACE VIEW src.v_base_espn_schedule
AS
	select distinct
		 a.league_id
		,a.game_id
		...
		,a.a10
		-- SELECT *
	from etl.stg_base_espn_schedule a
	left join src.espn_schedule s on a.game_id = s.game_id and s.league_id = 4
	where (
