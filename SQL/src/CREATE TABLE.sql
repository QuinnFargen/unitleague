...
--drop table src.foot_defensive_box;
--drop table src.foot_offensive_box;
--drop table src.foot_special_teams_box ;
--drop table src.foot_game_team_summary ;
...
CREATE TABLE src.foot_schedule (
    league_id           INT NOT NULL,       -- Added on insert from csv, 2 NFL, 5 CFB
    game_id             BIGINT,
    ...
    q4_away             INT,
    q5_away             INT,
    foot_schedule_id  bigint GENERATED BY DEFAULT AS IDENTITY,
    PRIMARY KEY (game_id)
);