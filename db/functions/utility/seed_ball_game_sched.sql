...
-----------------------
-- Load ball.game from src.foog_schedule
...
-- Load ball.sched from ball.game
	...
	join ball.season s on g.league_id = s.league_id and g.game_dt between s.reg_start_dt - interval '2 month' and s.champ_series_start_dt + interval '2 month'
	where 1=1
