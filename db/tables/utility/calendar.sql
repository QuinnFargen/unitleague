...
CREATE TABLE IF NOT EXISTS utility.calendar (
...
DO $$
BEGIN
    -- Check if table exists and has no rows
    IF to_regclass('utility.calendar') IS NOT NULL THEN
        IF NOT EXISTS (SELECT 1 FROM utility.calendar LIMIT 1) THEN    
            ...
            INSERT INTO utility.calendar
                SELECT  
                    ...
                    DATE_TRUNC('week', datum)::date "Week_Monday",
